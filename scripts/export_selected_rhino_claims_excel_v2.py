...
excel_path = os.path.join(exports_dir, f"rhino_claims_selected_export_{timestamp}.xlsx")
...
# Highlight unpaid claims (where "Claim Status" is not "Paid")
...
print(f"✅ Export completed: {excel_path}")
